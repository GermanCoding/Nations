...
public class ChangedBlock {
	...
	/**
	 * 
	 * @param l Location of this block.
	 * @param type Original type for restoring.
	 * @param data Original data for restoring.
	 */
	...
	public void restore()
	{
		...
		if(baseBlock != null)
		{
			...
			while(i.hasNext())
			{
				...
				if(playerLocation.distanceSquared(location) < (Bukkit.getViewDistance() * 16) * (Bukkit.getViewDistance() * 16))
